...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(9, WHITE, BLACK, "Press 1 to play again.");
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(4, WHITE, BLACK, "You put on the Amulet of Yala and feel its power course through \
                                 your veins.");
    ...
    fn advance_level(&mut self, _ctx: &mut BTerm) {
